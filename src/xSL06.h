...
class xSL06: public xCoreClass
{
	public:
		...
		*/	
		...
		/*
		* Determine the Mode of the Sensor
		*
		* @return true if setup was successful.
		*/	
		...
		* @param mode, 
		* @param enable, 
		* @return true if mode set was successful.
		*/	
	    bool setMode(uint8_t mode, uint8_t enable);	

		/*
		* Enable/Disable the power on the SL06 
		*
